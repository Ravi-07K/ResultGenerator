...
<center><img src="LNCT.jpg" width="100" height="100">
                            ...
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="subject_7">
                                    </div>
                                </div>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
	  ...
	  <% try 
	  {
	      ...
	      ResultSet rs = st.executeQuery("select s.* from student s");
	      while(rs.next())
	      {
	  %>
        <tr>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
	  ...
	  <% try 
	  {
	      Connection con = ConnectionProvider.getCon();
              Statement st = con.createStatement();
	      ResultSet rs = st.executeQuery("select r.* from result r");
	      while(rs.next())
	      {
	  %>
        <tr>
